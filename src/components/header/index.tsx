  ...
  return (
    <div className={styles.header}>
      <div className={styles.bar}>
        <Link href="/">
          <h1 className="text-xl">JadeByTaty</h1>
        ...
        >
          ...
          <div className={styles.label}>
            ...
            <motion.p variants={opacity} animate={isActive ? "open" : "closed"} className="text-xl">
              Close
            </motion.p>
          </div>
        </div>
        ...
        >
          ...
          <div className={styles.el}>
            ...
            <p className="md:text-sm">Cart(0)</p>
          </div>
        </motion.div>
      </div>
      <AnimatePresence mode="wait">
        {isActive && <NavComponent/>}
      </AnimatePresence>
    </div>
  );
}
